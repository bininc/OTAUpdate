...
public class ReflectHelper
{
    ...
    public static Object GetInstance(string filePath, string className)
    {
        ...
        {
            throw new Exception("GetInstance(string filePath, string className)出错！\n" + ex.Message);
        }
    }
    ...
    public static Object GetInstance(string className, System.Reflection.Assembly a)
    {
        ...
        {
            throw new Exception("GetInstane(string className, System.Reflection.Assembly a)出错！\n" + ex.Message);
        }
    }
    /// <summary>
    /// 反射执行实例中的方法
    ...
    public static object InvokeStaticMethod(Type type, string methodName, object[] args)
    {
        ...
        {
            throw new Exception("InvokeStaticMethod(Type type, string methodName, object[] args)出错！\n" + ex.Message);
        }
    }
    /// <summary>
    /// 通过反射执行静态方法
    ...
    public static object InvokeStaticMethod(string className, Assembly a, string methodName, object[] args)
    {
        ...
        {
            throw new Exception("InvokeStaticMethod(string className, Assembly a, string methodName, object[] args)出错！\n" + ex.Message);
        }
    }
    /// <summary>
    /// 通过反射执行静态方法
    ...
    public static object InvokeStaticMethod(string filePath, string className, string methodName, object[] args)
    {
        ...
        {
            throw new Exception(string.Format("InvokeStaticMethod出错！({0}，{1}，{2})\n{3}", filePath, className, methodName, ex.Message));
        }
    }
}
